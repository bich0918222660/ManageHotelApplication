...
import ui.pnl.Pnl_ManageEmployeeAndAccount;
import ui.pnl.Pnl_ManageBooking;
import ui.pnl.Pnl_SearchAndBooking;

public class Frm_ManageHotel_SuperAdmin extends JFrame {

	private Font fontSan = new Font("Arial", Font.BOLD, 13);
	
	public Frm_ManageHotel_SuperAdmin() {
	...
	private void init() {
        ...
        tabbedPane.addTab("Quản lý nhân viên", tabIconManage, new Pnl_ManageEmployeeAndAccount(), "click to show panel 5");
        
        add(tabbedPane);
	}
	
	public static void main(String[] args) {
		new Frm_ManageHotel_SuperAdmin().setVisible(true);
	}
